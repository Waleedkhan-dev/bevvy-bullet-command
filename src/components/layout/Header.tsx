      ...
      <div className="flex items-center gap-6">
        ...
        >
          ...
          <div className="flex items-center gap-1 font-mono text-sm">
            ...
            <span className="text-muted-foreground">:</span>
            <span className="text-foreground">{formatNumber(countdown.hours)}</span>
            <span className="text-muted-foreground">:</span>
            <span className="text-foreground">{formatNumber(countdown.minutes)}</span>
            <span className="text-muted-foreground">:</span>
            <span className="text-foreground">{formatNumber(countdown.seconds)}</span>
          </div>
        </motion.div>
